...
export function getChartTheme(): IChartTheme {
  ...
  return {
    ...
    .getPropertyValue("--humidity").trim(),
    humidityBg: styles.getPropertyValue("--humidity-bg").trim(),
    foreground: styles.getPropertyValue("--chart-foreground").trim(),
    humidityHoverRadius: parseInt(styles.getPropertyValue("--humidity-hover-radius").trim()),
    temperatureHoverRadius: parseInt(styles.getPropertyValue("--temperature-hover-radius").trim()),
